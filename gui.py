    ...
    def __init__(self):
        ...
        self.layout = [[sg.Text('Паспорт на кантователь', font='Monotype', size=(400, 1), justification='center',  )],#relief=sg.RELIEF_RAISED,
          [sg.Text('Ввести номер заявки', size=(15, 1),), sg.InputText('№ Заявки'), ],
            [sg.Text('Ввести Наименование', size=(15, 1)), sg.InputText('Кантователь катушек', enable_events=True, key='-name-')],
          ...
          [sg.Text('_'  * 80)],
          [sg.OK('Заполнить', size=(20,2), button_color='green', pad=(40,0)), sg.Cancel("Выход", size=(20,2), button_color='red', pad=(5,0))]]
